<!-- Footer -->
    <footer class="py-6 " style="background-color: #7EB5A6;">
      <div class="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div class="grid grid-cols-12">
          ...
          <div class="col-span-6 text-center md:text-left md:col-span-4 md:my-10">
            <p class="pb-1 text-lg font-medium text-white">Contact</p>
            <ul class="text-gray-200 text-sm md:text-base">
              ...
              <li class="py-3 flex ">
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-5 h-5 fillCurrent">
          ...
          <div class="col-span-6 text-center  md:col-span-3 md:my-10">
            <p class="pb-1 text-lg font-medium text-white">Lokasi</p>
            <ul class="text-gray-100 text-xs md:text-base ">
        ...
        <div class="grid justify-center pt-6">
          <div class="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
            <span class="text-white">©2021 Naturalisme | All rights reserved</span>
